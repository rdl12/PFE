import { View,Image,TouchableOpacity, PermissionsAndroid, FlatList,Text,SafeAreaView} from 'react-native'
        ...
        <TouchableOpacity style={{ padding : 10, backgroundColor : '#ffff',borderBottomWidth : 1, borderColor : "#eee",elevation:3,justifyContent:'space-between'}}
                    ...
                    <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                        <View style={{display:'flex',justifyContent:'flex-start',flexDirection:'row'}}>
                            <Icon name="thumb-tack" size={20} color='blue' style={{margin:5}}  />
    ...
    render (){
      let markers_filtered = this.props.markers.filter(
        ...
        return (
            <View style = {{flex:2}}>
             <TouchableOpacity
                      style={{ margin: 30, marginBottom:-30, zIndex:3,position:"absolute"}}
            ...
            <DropDownPicker
                ...
                style={{backgroundColor: '#fafafa',position:"absolute",zIndex:2,left:windowWidth/1.47,top:40, height:40,width:110}}
                itemStyle={{
                    justifyContent: 'flex-start'
                }}
                dropDownStyle={{backgroundColor: '#fafafa',position:"absolute",zIndex:2,left:windowWidth/1.9}}
            ...
            {markers_filtered  && markers_filtered .map(marker => (
                    <Marker
                        ...
                        description={marker.description}>
                           <Icon name="thumb-tack" size={40} color='blue'   />
                    </Marker>
