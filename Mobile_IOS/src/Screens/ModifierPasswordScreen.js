    ...
    return (
        <SafeAreaView style = {{flex:1}}>
          ...
          <Block safe flex middle >
            ...
            <View style={{ flexDirection: 'row', paddingHorizontal: SIZES.radius, height: 60, alignItems: 'center',elevation:3, backgroundColor:COLORS.primary, marginTop:40}}>
                  <TouchableOpacity
                      style={{ marginLeft: -8 }}
              ...
              <Block flex={0.35} middle style={styles.socialConnect}>
                   ...
                   <Text color="#8898AA" size={18}> /  Reset Password</Text> 
                    ...
                    <Icon name="unlock-alt" size={80}  resizeMode="contain" color={COLORS.darkgray} style={{alignSelf:'center', marginTop:20}}/>
