    ...
    render() {
      return (
        <SafeAreaView style={{backgroundColor:COLORS.WHITE}}>
          {/* Header */}
          <View style={{ flexDirection: 'row', paddingHorizontal: SIZES.radius, height: 60, alignItems: 'center',elevation:3 ,backgroundColor:COLORS.WHITE, shadowOpacity: 0.2,}}>
                  <TouchableOpacity
                      style={{ marginLeft: -8 }}
...
const styles = StyleSheet.create({
    ...
    header :{ backgroundColor:COLORS.WHITE, padding:20, margin:10,},
