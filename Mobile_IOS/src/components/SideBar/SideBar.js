              ...
              />
                ...
                <Drawer.Section style={styles.drawerSection}>
                    ...
                    <DrawerItem
                        ...
                        icon={() => (
                            <Image 
                            style={{backgroundColor: 'rgba(0,86,0,0.23)',width: 25,height: 25,borderRadius:50,tintColor:"#228B22"}}
         ...
         { LoginInfo.isLoggedIn ?  (<DrawerItem 
                        ...
                        icon={() => (
                            ...
                            <Icon   name="user" size={20}  
                                    style={{backgroundColor:"#ececec",width: 25,height: 25, paddingLeft:6,paddingTop:2,paddingBottom:-5}} 
                                    color="black"   />
                            </View>
